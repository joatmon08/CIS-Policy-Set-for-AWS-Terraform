...
policy "iam-password-uppercase" {
  source = "https://registry.terraform.io/v2/policies/hashicorp/CIS-Policy-Set-for-AWS-Terraform/1.0.1/policy/iam-password-uppercase.sentinel?checksum=sha256:5dc964807496ac535e9d36bd`0ed809cffffa39af6c1a75a653aa40795c93f593"
  enforcement_level = "advisory"
}
